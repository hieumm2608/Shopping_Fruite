	...
	<div class="container topbar bg-primary d-none d-lg-block">
		<div class="d-flex justify-content-between">
			...
			<div class="top-link pe-2">
				<a href="/404" class="text-white"><small class="text-white mx-2">Privacy
						Policy</small>/</a> <a href="/404" class="text-white"><small
					class="text-white mx-2">Terms of Use</small>/</a> <a href="/404"
			...
			<div class="collapse navbar-collapse bg-white" id="navbarCollapse">
				<div class="navbar-nav mx-auto">
					<a href="/index" class="nav-item nav-link active">Home</a> <a
						...
						href="/shop-detail" class="nav-item nav-link">Shop Detail</a>
					<div class="nav-item dropdown">
						<a href="#" class="nav-link dropdown-toggle"
							data-bs-toggle="dropdown">Pages</a>
						<div class="dropdown-menu m-0 bg-secondary rounded-0">
							<a href="/cart" class="dropdown-item">Cart</a> <a
								href="/chackout" class="dropdown-item">Chackout</a> <a
								href="/testimonial" class="dropdown-item">Testimonial</a> <a
								href="/404" class="dropdown-item">404 Page</a>
						</div>
					</div>
				...
				<div class="d-flex m-3 me-0">
					...
					<div class="nav-item dropdown">
						...
						<div class="dropdown-menu m-0 bg-secondary rounded-0">
							...
							<c:choose>
								<c:when test="${ulg == null}">
									<a href="/login" class="dropdown-item">Log in</a>
									<a href="/signup" class="dropdown-item">Sign up</a>
								</c:when>
								<c:otherwise>
									<a href="/login" class="dropdown-item">hi: ${ulg.fullname}</a>
									<a href="/UserManager" class="dropdown-item">Manager
										Account</a>
									<hr>
