	...
	<div class="row manager">
				...
				<C:choose>
					<C:when test="${ulg.role == true}">
						<a href="/UserManager"
							...
							aria-current="true"> Thông tin tài khoản </a>
						<a href="/CartManager"
						...
						<a href="/ProductManager"
							...
							phẩm (admin)</a>
						<a href="/Admin" class="list-group-item list-group-item-action">Quản
							lí người dùng (admin)</a>
		...
		<div class="col-8">
			...
			<form action="/AccountManager" method="post">
				<div class="mb-3">
					<label for="" class="form-label">Mật khẩu hiện tại:</label> <input
						type="text" class="form-control" id="" aria-describedby=""required name="cPass"> 
				</div>
				<div class="mb-3">
					<label for="exampleInputEmail1" class="form-label">Mật khẩu
						mới</label> <input type="password" class="form-control" id="" required
						aria-describedby="" name="pass1Am"> 
				</div>
				<div class="mb-3">
					<label for="exampleInputEmail1" class="form-label">Xác nhận
						mật khẩu</label> <input type="password" class="form-control" id="" required
						aria-describedby="" name="pass2Am">
				</div>
